...
echo "!!!test/chuzhong"
THEANO_FLAGS="mode=FAST_RUN,device=${gpu},floatX=float32" stdbuf -i0 -e0 -o0 python main.py -train_file ../data/data/train -dev_file ../data/data/test/chuzhong -embedding_size 100  -pre_trained ${model} -test_only True ${option_suffix}
echo "!!!test/gaozhong"
THEANO_FLAGS="mode=FAST_RUN,device=${gpu},floatX=float32" stdbuf -i0 -e0 -o0 python main.py -train_file ../data/data/train -dev_file ../data/data/test/gaozhong -embedding_size 100 -pre_trained ${model} -test_only True ${option_suffix}
